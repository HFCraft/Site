  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Jogar no Minecraft Bedrock Edition" />
        ...
        <meta property="og:url" content="https://www.hfcraft.xyz/play/bedrock" />
        <meta property="og:type" content="website" />

        <meta name="twitter:title" content="Jogar no Minecraft Bedrock Edition" />
        <meta
        ...
        <meta name="twitter:url" content="https://www.hfcraft.xyz/play/bedrock" />
        <meta
          name="twitter:image"
          content="/_next/image?url=/images/CreeperFace.webp&w=16h=16&q=75"
        />

        <title>Bedrock | HFCraft</title>
      </Head>
      <div id="container">
        <div
            ...
            <p className="font-MinecraftFiveBold text-3vw flex justify-center content-center text-slate-200">
              <button className="bg-gray-50 hover:bg-gray-100 text-gray-800 font-bold py-2 px-4 mb-2 rounded inline-flex cursor-not-allowed">
                <span className="text-1.5vw font-MinecraftFiveBold">
                  br-1.purplehost.com.br
                </span>
              </button>
              <button className="ml-3 bg-gray-50 hover:bg-gray-100 text-gray-800 font-bold py-2 px-4 mb-2 rounded inline-flex cursor-not-allowed">
                <span className="text-1.5vw font-MinecraftFiveBold">
                  10013
                </span>
              </button>
